        ...
        <tbody>
            <tr>
                ...
                <td style="vertical-align:top;">
                    ...
                    <p style="-webkit-margin-before:0;-webkit-margin-after:0;font-family:Lucida Sans, Arial, sans-serif;font-size:12px;color:#473741;letter-spacing:1;margin:0;">Tfno. {{ person.phone }}</p>
