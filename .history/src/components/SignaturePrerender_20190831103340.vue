        ...
        <tbody>
            <tr>
                ...
                <td style="vertical-align:top;">
                    ...
                    ${person.role ? `<p style="-webkit-margin-before:0;-webkit-margin-after:0;font-family:Lucida Sans, Arial, sans-serif;font-size:14px;color:#473741;letter-spacing:1;margin:0;">${person.role}</p>` : '' }
                    ...
                    ${person.fb ? `<a href="${person.fb}" style="text-decoration:none;"><img src="https://grupolamusa.com/firma/2019/shared/grupo-la-musa-fb.jpg" alt="Facebook" width="25" height="25" style="margin:5px 0 0 0;"></a>` : '' }
                    ${person.ig ? `<a href="${person.ig}" style="text-decoration:none;"><img src="https://grupolamusa.com/firma/2019/shared/grupo-la-musa-ig.jpg" alt="Instagram" width="25" height="25" style="margin:5px 0 0 5px;"></a>` : '' }
                    ${person.tw ? `<a href="${person.tw}" style="text-decoration:none;"><img src="https://grupolamusa.com/firma/2019/shared/grupo-la-musa-tw.jpg" alt="Twitter" width="25" height="25" style="margin:5px 0 0 5px;"></a>` : '' }
                    <br/>
            ...
            <tr>
                <td style="vertical-align:top;" colspan="3" width="420">
                    <p style="text-align:justify;-webkit-margin-before:0;-webkit-margin-after:0;font-size:7px;font-family:Lucida Fax, Georgia, serif;font-weight:normal;margin:0;color:#473741">
                        <strong>AVISO LEGAL</strong>: Este mensaje y sus archivos adjuntos van dirigidos exclusivamente a su destinatario, pudiendo contener información confidencial sometida a secreto profesional. No está permitida su comunicación, reproducción o distribución sin la autorización expresa de ${person.bussines}. Si usted no es el destinatario final, por favor elimínelo e infórmenos por esta vía.
                    </p>
